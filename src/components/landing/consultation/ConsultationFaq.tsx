...
const faqs = [
  {
    ...
    answer:
      "Yes. Based on your specific requirements, our support coordinators will connect you with trusted NDIS providers. Additionally, we focus on capacity building to help you develop the skills needed to manage service providers independently in the future.",
  },
  {
    question: "How Can You Help Me Access The Community?",
    answer:
      "We support community access through our Social & Community Participation and Transportation Assistance services. Our team helps you access community resources, attend events, and build social connections to combat isolation, while our support workers assist with travel to ensure you reach your destination safely.",
  },
  {
    question: "Are The NDIS Accommodations That You Provide Well-maintained?",
    answer:
      "Absolutely. For our Emergency Respite and short-term accommodation services, we provide safe, clean, and comfortable living spaces. We ensure our facilities meet high standards so you can relax and feel at home during your stay.",
  },
  {
    question: "Do You Use Restrictive Practices During Psychosocial Recovery Coaching?",
    answer:
      "No. As a neuro-affirming provider, we treat everyone with kindness and respect your autonomy. We do not decide for you; instead, we provide the tools and coaching you need to navigate challenges and achieve your own definition of independence.",
  },
];
      ...
      <div className="max-w-8xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-8">
          ...
          >
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight uppercase tracking-tighter">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className={`w-full text-left p-4 md:p-6 rounded-[2rem] transition-all duration-500 flex items-center justify-between gap-6 border-2 ${
                  activeIndex === index
              ...
              >
                <span
                  className={`text-base md:text-lg font-black leading-tight transition-colors duration-300 ${
                    activeIndex === index
                      ? "text-[#2D3748]"
                      : "text-[#2D3748]/70"
                  }`}
              ...
              <AnimatePresence>
                {activeIndex === index && (
                  ...
                  >
                    <div className="p-6 md:p-8 pt-3 text-gray-600 text-base leading-relaxed font-medium">
                      <div className="h-px w-full bg-[#ABB3F1]/20 mb-4" />
                      {faq.answer}
                    </div>
                  </motion.div>
                )}
