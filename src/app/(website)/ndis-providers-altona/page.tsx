...
const services = [
    ...
    },
    {
        ...
        description: "NDIS providers in Altona offer access to allied health professionals such as physiotherapists and occupational therapists, helping participants improve their health, mobility, and communication skills in a supportive environment."
    },
    {
...
const locationSchemas = [
    {
        ...
        "@type": "LocalBusiness",
        "@id": "https://jschoicegroup.com.au/ndis-providers-altona#localbusiness",
        name: "JS Choice Group - NDIS Providers Altona",
        description: "NDIS provider in Altona offering personalised disability support services across Melbourne.",
        url: "https://jschoicegroup.com.au/ndis-providers-altona",
        ...
        areaServed: { "@type": "City", name: "Altona" },
    ...
    },
    {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "NDIS Providers Altona", item: "https://jschoicegroup.com.au/ndis-providers-altona" },
        ],
    },
    {
        "@context": "https://schema.org",
...
const NdisProvidersAltona = () => {
    return (
        <main className="bg-gray-50/50">
            <JsonLd data={locationSchemas} />
            <PageHeader
                title="NDIS Providers Altona"
                breadcrumb={[
                    { label: "Home", href: "/" },
                    { label: "NDIS Providers Altona" }
                ]}
            />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="relative h-[500px] w-full">
                                <Image quality={80}
                                    src="/images/altona/ndis-provider-altona-1.webp"
                                    alt="NDIS Providers Altona"
                                    fill
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                    Experienced NDIS Providers in Altona <span className="text-primary block mt-2">Offering Personalised Services</span>
                                </h2>
                            </div>
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    At Js Choice – Care and Support, we offer personalised care that is designed to empower individuals to live their best lives. Our NDIS providers in Altona focus on offering tailored support by working with participants to develop a plan that suits their lifestyle, goals, and preferences.
                                </p>
                                <p>
                ...
                <div className="container-8xl relative z-10 text-center">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight text-white">
                            Get NDIS Support <span className="text-primary">in Altona Today</span>
                        </h2>
                ...
                <div className="container-8xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="relative h-[500px] w-full">
                                <Image quality={80}
                                    src="/images/altona/ndis-provider-altona-2.webp"
                                    alt="Why Choose Us"
                                    fill
                                    className="rounded-[2.5rem] shadow-2xl object-cover"
                                />
                        ...
                        >
                            <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                Why Choose Our NDIS <span className="text-secondary">Providers in Altona?</span>
                            </h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="lg:order-1">
                            ...
                            <div className="relative h-[600px] w-full">
                                <Image quality={80}
                                    src="/images/altona/ndis-provider-altona-3.webp"
                                    alt="NDIS Services"
                                    fill
                                    className="rounded-[2.5rem] shadow-2xl object-cover"
                                />
                ...
                <div className="container-8xl max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-black text-[#2D3748]">
                            Frequently Asked Questions <span className="text-secondary">on NDIS Providers in Altona</span>
                        </h2>
                    </div>
...
export default NdisProvidersAltona;
