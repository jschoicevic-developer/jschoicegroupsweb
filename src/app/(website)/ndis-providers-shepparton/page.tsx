...
const services = [
    ...
    },
    {
        ...
        description: "NDIS providers in Shepparton offer access to allied health professionals such as physiotherapists and occupational therapists, helping participants improve their health, mobility, and communication skills in a supportive environment."
    },
    {
...
const locationSchemas = [
    {
        ...
        "@type": "LocalBusiness",
        "@id": "https://jschoicegroup.com.au/ndis-providers-shepparton#localbusiness",
        name: "JS Choice Group - NDIS Providers Shepparton",
        description: "NDIS provider in Shepparton offering personalised disability support services across Victoria.",
        url: "https://jschoicegroup.com.au/ndis-providers-shepparton",
        ...
        areaServed: { "@type": "City", name: "Shepparton" },
    ...
    },
    {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "NDIS Providers Shepparton", item: "https://jschoicegroup.com.au/ndis-providers-shepparton" },
        ],
    },
    {
        "@context": "https://schema.org",
...
const NdisProvidersShepparton = () => {
    return (
        <main className="bg-gray-50/50">
            <JsonLd data={locationSchemas} />
            <PageHeader
                title="NDIS Providers Shepparton"
                breadcrumb={[
                    { label: "Home", href: "/" },
                    { label: "NDIS Providers Shepparton" }
                ]}
            />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="relative h-[500px] w-full">
                                <Image quality={80}
                                    src="/images/shepparton/ndis-provider-shepparton-1.webp"
                                    alt="NDIS Providers Shepparton"
                                    fill
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                    Trusted NDIS Providers in <span className="text-primary block mt-2">Shepparton</span>
                                </h2>
                            </div>
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    At Js Choice – Care and Support, we offer personalised care that is designed to empower individuals to live their best lives. Our NDIS providers in Shepparton focus on offering tailored support by working with participants to develop a plan that suits their lifestyle, goals, and preferences.
                                </p>
                                <p>
                ...
                <div className="container-8xl relative z-10 text-center">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight text-white">
                            Get NDIS Support <span className="text-primary">in Shepparton Today</span>
                        </h2>
                ...
                <div className="container-8xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="relative h-[500px] w-full">
                                <Image quality={80}
                                    src="/images/shepparton/ndis-provider-shepparton-2.webp"
                                    alt="Why Choose Us"
                                    fill
                                    className="rounded-[2.5rem] shadow-2xl object-cover"
                                />
                        ...
                        >
                            <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                Why Choose Our NDIS <span className="text-secondary">Providers in Shepparton?</span>
                            </h2>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                        ...
                        <div className="lg:order-1">
                            ...
                            <div className="relative h-[600px] w-full">
                                <Image quality={80}
                                    src="/images/shepparton/ndis-provider-shepparton-3.webp"
                                    alt="NDIS Services"
                                    fill
                                    className="rounded-[2.5rem] shadow-2xl object-cover"
                                />
            ...
            {/* Bottom CTA */}
            <section className="py-10 lg:py-14 bg-[#2D3748] text-white overflow-hidden relative">
                <div className="container-8xl relative z-10 text-center">
                    <motion.div
                ...
                <div className="container-8xl max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-black text-[#2D3748]">
                            Frequently Asked Questions <span className="text-secondary">on NDIS Providers in Shepparton</span>
                        </h2>
                    </div>
...
export default NdisProvidersShepparton;
