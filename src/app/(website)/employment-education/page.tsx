...
const serviceSchemas = [
    {
        ...
        "@type": "Service",
        "@id": "https://www.jschoicegroup.com.au/employment-education/#service",
        name: "Employment & Education Support",
        serviceType: "NDIS Employment and Education Support",
        url: "https://www.jschoicegroup.com.au/employment-education",
        description: "JS Choice - Care and Support provides NDIS Employment and Education Support across Melbourne, helping participants develop skills, build confidence, access learning opportunities, prepare for employment, and achieve their personal career and education goals through personalised support.",
        ...
        category: "NDIS Employment and Education Services",
        availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: "https://www.jschoicegroup.com.au/employment-education",
        ...
        hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "Employment & Education Support Services",
            itemListElement: [
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Employment Goal Planning" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Job Readiness Training" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Workplace Skills Development" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Education and Learning Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Capacity Building for Independence" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Support with Finding and Maintaining Employment" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Confidence Building and Social Skills Development" } },
            ],
        },
    },
    {
