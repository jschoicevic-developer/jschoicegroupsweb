...
const locationSchemas = [
    {
        ...
        "@type": "LocalBusiness",
        "@id": "https://jschoicegroup.com.au/ndis-providers-footscray#localbusiness",
        name: "JS Choice Group - NDIS Providers Footscray",
        description: "NDIS provider in Footscray offering personalised disability support services across Melbourne.",
        url: "https://jschoicegroup.com.au/ndis-providers-footscray",
        ...
        areaServed: { "@type": "City", name: "Footscray" },
    ...
    },
    {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "NDIS Providers Footscray", item: "https://jschoicegroup.com.au/ndis-providers-footscray" },
        ],
    },
    {
        "@context": "https://schema.org",
...
const NdisProvidersFootscray = () => {
    return (
        <main className="bg-gray-50/50">
            ...
            <ServiceFormSection
                source="service_page"
                sourcePage="/ndis-providers-footscray"
