...
const services = [
    ...
    },
    {
        ...
        description: "NDIS providers in Altona North offer access to allied health professionals such as physiotherapists and occupational therapists, helping participants improve their health, mobility, and communication skills in a supportive environment."
    },
    {
...
const locationSchemas = [
    {
        ...
        "@type": "LocalBusiness",
        "@id": "https://jschoicegroup.com.au/ndis-providers-altona-north#localbusiness",
        name: "JS Choice Group - NDIS Providers Altona North",
        description: "NDIS provider in Altona North offering personalised disability support services across Melbourne.",
        url: "https://jschoicegroup.com.au/ndis-providers-altona-north",
        ...
        areaServed: { "@type": "City", name: "Altona North" },
    ...
    },
    {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "NDIS Providers Altona North", item: "https://jschoicegroup.com.au/ndis-providers-altona-north" },
        ],
    },
    {
        "@context": "https://schema.org",
...
const NdisProvidersAltonaNorth = () => {
    return (
        <main className="bg-gray-50/50">
            <JsonLd data={locationSchemas} />
            <PageHeader
                title="NDIS Providers Altona North"
                breadcrumb={[
                    { label: "Home", href: "/" },
                    { label: "NDIS Providers Altona North" }
                ]}
            />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                        ...
                        >
                            ...
                            <div className="relative h-[500px] w-full">
                                <Image quality={80}
                                    src="/images/altona-north/ndis-provider-altona-north-1.webp"
                                    alt="NDIS Providers Altona North"
                                    fill
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                    Trusted NDIS Providers in <span className="text-primary block mt-2">Altona North</span>
                                </h2>
                            </div>
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    At Js Choice – Care and Support, we offer personalised care that is designed to empower individuals to live their best lives. Our NDIS providers in Altona North focus on offering tailored support by working with participants to develop a plan that suits their lifestyle, goals, and preferences.
                                </p>
                                <p>
                ...
                <div className="container-8xl relative z-10 text-center">
                    ...
                    >
                        <h2 className="text-3xl md:text-5xl font-black mb-6 leading-tight text-white">
                            Get NDIS Support <span className="text-primary">in Altona North Today</span>
                        </h2>
                ...
                <div className="container-8xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <div className="relative h-[500px] w-full">
                                <Image quality={80}
                                    src="/images/altona-north/ndis-provider-altona-north-2.webp"
                                    alt="Why Choose Us"
                                    fill
                                    className="rounded-[2.5rem] shadow-2xl object-cover"
                                />
                        ...
                        >
                            <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                Why Choose Our NDIS <span className="text-secondary">Providers in Altona North?</span>
                            </h2>
                ...
                <div className="container-8xl max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-black text-[#2D3748]">
                            Frequently Asked Questions <span className="text-secondary">on NDIS Providers in Altona North</span>
                        </h2>
                    </div>
            ...
            <ServiceFormSection
                source="service_page"
                sourcePage="/ndis-providers-altona-north"
...
export default NdisProvidersAltonaNorth;
