...
const serviceSchemas = [
    {
        ...
        "@type": "Service",
        "@id": "https://www.jschoicegroup.com.au/assistance-with-nursing-care/#service",
        name: "Assistance with Nursing Care",
        serviceType: "NDIS Community Nursing Care",
        url: "https://www.jschoicegroup.com.au/assistance-with-nursing-care",
        description: "JS Choice - Care and Support provides professional NDIS Community Nursing Care in Melbourne. Our qualified nurses deliver personalised clinical care, medication management, wound care, chronic disease management, health monitoring, and coordinated nursing support to help participants maintain their health, independence, and wellbeing at home.",
        ...
        category: "Community Nursing Care",
        availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: "https://www.jschoicegroup.com.au/assistance-with-nursing-care",
        ...
        hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "Community Nursing Care Services",
            itemListElement: [
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Medication Management" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Wound Care" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Health Monitoring" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Chronic Disease Management" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Care Coordination" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Home-Based Nursing Care" } },
            ],
        },
    },
    {
