...
const serviceSchemas = [
    {
        ...
        "@type": "Service",
        "@id": "https://www.jschoicegroup.com.au/ndis-access-requests/#service",
        name: "NDIS Access Requests",
        serviceType: "NDIS Access Request Assistance",
        url: "https://www.jschoicegroup.com.au/ndis-access-requests",
        description: "JS Choice - Care and Support provides NDIS Access Request assistance in Melbourne, helping individuals understand the NDIS application process, prepare required documentation, gather supporting evidence, and navigate the requirements needed to apply for NDIS support.",
        provider: { "@id": "https://www.jschoicegroup.com.au/#organization" },
        areaServed: { "@type": "State", name: "Victoria", addressCountry: "AU" },
        audience: { "@type": "PeopleAudience", audienceType: "People Applying for NDIS Support" },
        category: "NDIS Application Support Services",
        availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: "https://www.jschoicegroup.com.au/ndis-access-requests",
        ...
        offers: {
            ...
            description: "Free consultation available for individuals seeking NDIS access support.",
        },
        hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "NDIS Access Request Assistance Services",
            itemListElement: [
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "NDIS Application Guidance" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Access Request Form Assistance" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Supporting Evidence Guidance" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Understanding NDIS Eligibility Requirements" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Connection with Appropriate NDIS Supports" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Ongoing Support Throughout the NDIS Access Process" } },
            ],
        },
    },
    {
