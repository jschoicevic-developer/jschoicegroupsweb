...
import {
    ...
    serviceFaqHeading,
    serviceFaqItems,
} from "@/data/group-centre-sections";
...
const serviceSchemas = [
    {
        ...
        "@type": "Service",
        "@id": "https://www.jschoicegroup.com.au/group-centre-activities/#service",
        name: "Group & Centre Activities",
        serviceType: "NDIS Group & Centre Activities",
        url: "https://www.jschoicegroup.com.au/group-centre-activities",
        description: "JS Choice - Care and Support provides NDIS Group & Centre Activities across Melbourne, offering inclusive, participant-led programs that build life skills, encourage social connection, promote community participation, and support greater independence in a safe and welcoming environment.",
        ...
        category: "NDIS Group & Centre-Based Activities",
        availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: "https://www.jschoicegroup.com.au/group-centre-activities",
        ...
        hasOfferCatalog: {
            ...
            name: "Group & Centre Activities",
            itemListElement: [
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Life Skills & Independence Programs" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Cooking Classes & Budgeting Workshops" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Arts, Crafts, Music & Gardening Activities" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Supported Community Outings & Recreation" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Travel Training & Capacity Building" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Social Skills Development & Community Participation" } },
            ],
        },
    },
    {
    ...
    return (
        <main className="bg-gray-50/50">
            ...
            <DailyLivingTasksSection
                ...
                imageSrc={activitiesImage.src}
                imageAlt={activitiesImage.alt}
                tasks={activitiesItems}
            />
