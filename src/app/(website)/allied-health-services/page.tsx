...
const serviceSchemas = [
    {
        ...
        "@type": "Service",
        "@id": "https://www.jschoicegroup.com.au/allied-health-services/#service",
        name: "Allied Health Services",
        serviceType: "NDIS Allied Health Services",
        url: "https://www.jschoicegroup.com.au/allied-health-services",
        description: "JS Choice - Care and Support provides NDIS Allied Health Services across Melbourne, working alongside qualified allied health professionals to deliver personalised therapeutic support that improves mobility, communication, independence, health, and overall wellbeing for participants.",
        ...
        category: "NDIS Allied Health Services",
        availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: "https://www.jschoicegroup.com.au/allied-health-services",
        ...
        hasOfferCatalog: {
            ...
            name: "Allied Health Services",
            itemListElement: [
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Occupational Therapy Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Physiotherapy Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Speech Pathology Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Exercise Physiology Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Dietitian Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Therapy Program Implementation" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Capacity Building & Functional Independence" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Clinical & Therapeutic Support" } },
            ],
        },
    },
    {
