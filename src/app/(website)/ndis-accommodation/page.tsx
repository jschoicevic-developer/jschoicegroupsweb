...
const serviceSchemas = [
    {
        ...
        "@type": "Service",
        "@id": "https://www.jschoicegroup.com.au/ndis-accommodation/#service",
        name: "NDIS Accommodation",
        serviceType: "NDIS Accommodation Services",
        url: "https://www.jschoicegroup.com.au/ndis-accommodation",
        description: "JS Choice - Care and Support provides NDIS Accommodation services in Melbourne, offering personalised housing solutions including Supported Independent Living (SIL), Medium-Term Accommodation (MTA), and Short-Term Accommodation (STA). These services are designed to provide safe, comfortable, and supportive living environments that promote independence, choice, and improved quality of life for NDIS participants.",
        ...
        category: "NDIS Accommodation and Supported Living Services",
        availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: "https://www.jschoicegroup.com.au/ndis-accommodation",
        ...
        hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "NDIS Accommodation Services",
            itemListElement: [
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Supported Independent Living (SIL)" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Medium-Term Accommodation (MTA)" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Short-Term Accommodation (STA)" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "24/7 Personalised Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Daily Living Assistance" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Personal Care and Household Support" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Neuro-Affirming and Culturally Safe Accommodation" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Independent Living Skill Development" } },
            ],
        },
    },
    {
