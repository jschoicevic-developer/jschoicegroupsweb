...
const services = [
    ...
    },
    {
        ...
        description: "NDIS providers in Altona Meadows offer access to allied health professionals such as physiotherapists and occupational therapists, helping participants improve their health, mobility, and communication skills in a supportive environment."
    },
    {
...
const locationSchemas = [
    {
        ...
        "@type": "LocalBusiness",
        "@id": "https://jschoicegroup.com.au/ndis-providers-altona-meadows#localbusiness",
        name: "JS Choice Group - NDIS Providers Altona Meadows",
        description: "NDIS provider in Altona Meadows offering personalised disability support services across Melbourne.",
        url: "https://jschoicegroup.com.au/ndis-providers-altona-meadows",
        ...
        areaServed: { "@type": "City", name: "Altona Meadows" },
    ...
    },
    {
        ...
        itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "NDIS Providers Altona Meadows", item: "https://jschoicegroup.com.au/ndis-providers-altona-meadows" },
        ],
    },
    {
        "@context": "https://schema.org",
...
const NdisProvidersAltonaMeadows = () => {
    return (
        <main className="bg-gray-50/50">
            <JsonLd data={locationSchemas} />
            <PageHeader
                title="NDIS Providers Altona Meadows"
                breadcrumb={[
                    { label: "Home", href: "/" },
                    { label: "NDIS Providers Altona Meadows" }
                ]}
            />
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                    Trusted NDIS Providers in <span className="text-primary block mt-2">Altona Meadows</span>
                                </h2>
                            </div>
                            <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                                <p>
                                    At Js Choice – Care and Support, we offer personalised care that is designed to empower individuals to live their best lives. Our NDIS providers in Altona Meadows focus on offering tailored support by working with participants to develop a plan that suits their lifestyle, goals, and preferences.
                                </p>
                                <p>
            ...
            <section className="py-10 bg-white relative">
                <div className="container-8xl">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        ...
                        >
                            <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                Why Choose Our NDIS <span className="text-secondary">Providers in Altona Meadows?</span>
                            </h2>
                ...
                <div className="container-8xl max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        <h2 className="text-3xl md:text-4xl font-black text-[#2D3748]">
                            Frequently Asked Questions <span className="text-secondary">on NDIS Providers in Altona Meadows</span>
                        </h2>
                    </div>
...
export default NdisProvidersAltonaMeadows;
