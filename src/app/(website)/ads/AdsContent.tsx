...
const QuoteCTA = ({ label = "Get a Free Quote", variant = "primary" }: { label?: string; variant?: "primary" | "secondary" | "dark" | "white" }) => {
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div>
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }} className="flex flex-col sm:flex-row items-start gap-4">
                        <QuoteCTA label="Get Your Free Quote" />
                        <a href="tel:0421622262" className="h-14 px-8 rounded-full border border-white/30 hover:bg-white/10 flex items-center gap-3 text-white transition-all hover:scale-105">
                            <Phone size={18} />
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
                        ...
                        <div className="space-y-5">
                            {[
                                { icon: Phone, label: "Call Us", value: "0421 622 262", href: "tel:0421622262" },
                    ...
                    >
                        <h3 className="text-2xl md:text-3xl font-black text-[#2D3748] mb-2 uppercase tracking-tight">
                            Get Your Free <span className="text-[#F1ABAB]">Quote</span>
                        </h3>
        ...
        <div className="max-w-8xl mx-auto px-4 md:px-6 lg:px-8 relative z-10 text-center">
            <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-4xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                    <a href="tel:0421622262" className="h-14 px-8 rounded-full bg-white/10 hover:bg-white/20 text-white flex items-center justify-center gap-3 shadow-xl transition-all min-w-[240px] border border-white/20">
                        <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center">
                            <Phone size={18} />
                        </div>
                        <span className="text-sm font-black uppercase tracking-widest">Call: 0421 622 262</span>
                    </a>
                    <QuoteCTA label="Enquire Online" variant="primary" />
                </div>
            </motion.div>
        </div>
    </section>
