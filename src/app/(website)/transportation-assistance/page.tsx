...
const serviceSchemas = [
    {
        ...
        "@type": "Service",
        "@id": "https://www.jschoicegroup.com.au/transportation-assistance/#service",
        name: "Transportation Assistance",
        serviceType: "NDIS Transportation Assistance",
        url: "https://www.jschoicegroup.com.au/transportation-assistance",
        description: "JS Choice - Care and Support provides reliable NDIS Transportation Assistance across Melbourne, helping participants travel safely and comfortably to medical appointments, work, education, shopping, social activities, and community events while promoting independence and community participation.",
        ...
        category: "NDIS Transport Assistance",
        availableChannel: {
            "@type": "ServiceChannel",
            serviceUrl: "https://www.jschoicegroup.com.au/transportation-assistance",
        ...
        hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "Transportation Assistance Services",
            itemListElement: [
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Transport to Medical Appointments" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Transport to Work and Education" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Shopping and Essential Errands" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Community and Social Activity Transport" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Accessible and Assisted Transport" } },
                { "@type": "Offer", itemOffered: { "@type": "Service", name: "Door-to-Door Travel Support" } },
            ],
        },
    },
    {
                        ...
                        >
                            <div className="space-y-4">
                                ...
                                <h2 className="text-4xl lg:text-5xl font-black text-[#2D3748] leading-tight">
                                    Transportation Assistance — Freedom to Move: <span className="text-primary block mt-2">Safe, Reliable NDIS Transport</span>
                                </h2>
                            </div>
